...
\begin{marginfigure}
    ...
    \caption[M87 jet]{Hubble Space Telescope composite image of the jet launched by the AGN in M87, \SI{17}{\mega\parsec} away. The large size of the SMBH in M87 made it the first target of the Event Horizon Telescope, resulting in the first direct image of a black hole ever taken~\cite{Akiyama2019}. Image credit: NASA/Hubble Heritage Team}
    \labfig{m87_jet}
\end{marginfigure}
