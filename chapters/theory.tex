...
The exact role the neutrinos play in SN explosions is still insufficiently understood, as one has to rely on data from \emph{SN1987A} only, supplemented by numerical simulations. Eventually, a CCSN within our galaxy might come to the rescue~\sidecite{Janka2017}.
