...
\begin{description}
    \item[Peak magnitude] The peak observed magnitude (regardless of filter). This value was scaled accordingly for the noisified and redshifted child light curves.
    ...
    \item[Distance to core] The median core distance was also included. To account for the fact that the core distance of the redshifted child light curves will change with respect to their parents, this value was recalculated for all children.
\end{description}