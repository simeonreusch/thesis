...
This method, here dubbed ``Noisification'', was developed by Alice Townsend, with significant contribution by the author. The procedure was implemented as Python package~\sidecite{Reusch2023c} and works as follows:
...
The latter approach was chosen here, so only those nuclear transients that survived the AGN rejection were kept for classification.
