...
\subsection{Inspection of Objects Classified as TDE}
...
The performance of the classifier yielded somewhat mixed results.
...
An overview table of the 34 transients that met this criterion can be seen in the Appendix in Table~\ref{tab:dustecho_selection}.

\subsection{New TDE and Accretion Flare Candidates}
Among this final selection were 13 TDE or accretion flare candidates that showed a strong dust echo, and which were not published so far. These comprise:
...
Two exemplary light curves are shown in Fig.\todo{figure}, one candidate TDE (\textit{ZTF18abtnfnq}), and one candidate accretion flare similar to \textit{AT2019fdr}: \textit{AT2020oio}.
