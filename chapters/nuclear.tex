...
\end{equation}
With this scaling factor, the flux of the child lightcurve simply is $f_\text{child} = a f_\text{parent}$.

If an \texttt{SNCosmo} model for the transient type did exist, \textbf{K-correction} was applied. This
