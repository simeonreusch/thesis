...
\begin{figure}[h!]
    \begin{tikzpicture}[node distance=1.4cm]
        ...
        \node (disc1a) [discard, font=\small, right of=dec1a, xshift=2.48cm] {Ignore};
        ...
        \node (disc2) [discard, font=\small, right of=dec2, xshift=2.76cm] {Discard 81,204,804 alerts};
        ...
        \node (disc3) [discard, font=\small, right of=dec3, xshift=2.5cm] {Discard 20,331 alerts};
        ...
        \node (disc4) [discard, font=\small, right of=dec4, xshift=2.5cm] {Discard 68,985 alerts};
        ...
        \node (disc5) [discard, font=\small, right of=dec5, xshift=2.5cm] {Discard 38,600 alerts};
        ...
        \node (disc6) [discard, font=\small, right of=dec6, xshift=2.5cm] {Discard 42,477 alerts};
        \node (keep6) [keepfinal, font=\small, below of=dec6] {Keep 11687 transients};
        ...
        \draw [arrow] (dec1a) -- node[midway,above] {\small yes} (disc1a);
    ...
    \end{tikzpicture}
    \caption[Nuclear filter flow chart]{Flow chart showing the rejection statistics of the nuclear filter. Note that the filter silently auto-accepts alerts belonging to a transient that has already passed the filter. This is why the final number of alerts equals the number of transients that pass the nuclear filter.}
