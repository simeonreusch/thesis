...
The routines used to generate and evaluate the nuclear sample were written in Python, and are accessible online\sidenote{\url{https://github.com/simeonreusch/ztfnuclear}}.
...
\begin{figure}[htpb]
    \includegraphics[width=0.6\textwidth]{nuclear/feature_importance_niter_50_nsample_2000.pdf}
...
\begin{figure}[htb]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_False_normaliz_None.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_False_normaliz_all.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_False_normaliz_pred.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_False_normaliz_true.pdf}
    \end{subfigure}
...
The bottom left matrix shows the prediction-normalized values: Each number is the percentage of the predicted classifications actually belonging to the predicted class. For example, \textcolor{red}{89\%} of all predicted TDE are actually TDE, the other \textcolor{red}{11\%} are AGN in truth. This corresponds to the false positive rate.\todo{check}

The truth-normalized matrix (bottom right) shows the percentage of objects correctly classified. \textcolor{red}{85\%} of all TDE were correctly identified, but \textcolor{red}{10\%} were misclassified as non-Ia SNe, and \textcolor{red}{5\%} were wrongly identified as SNe Ia.

The performance looks quite decent, especially
...
The sample looks more balanced due to the inclusion of more noisified child light curves for underrepresented classes (except stars).

\begin{figure}[htb]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_True_normaliz_None.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_True_normaliz_all.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_True_normaliz_pred.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{nuclear/confusion/results_seed_10_n_iter_50_noisified_val_True_normaliz_true.pdf}
    \end{subfigure}
