...
In a regular \textbf{decision tree}, a set of binary decisions are employed to decide on the classification. \textbf{Random forests} build upon this concept by using (a) multiple decision trees with (b) a random subset of features. Alternatively, decision trees can be \textbf{boosted}, meaning they are generated an evaluated in sequence, each tree being fed the residuals of the previous tree.