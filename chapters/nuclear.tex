...
% snia fit plots schlecht


% The prior used for the Bayesian Block analysis was $10 \times \log(n_\text{data})$, 
% WELCHER PRIOR

% AGN rejection: diskutieren, dass es manchmal nur so manchmal funktioniert

% noisified children, entweder nur children oder "noisified copy"

% erklärung was feature importance ist
...
% visual cuts --> 2 d cuts


% candidate list weglassen, auf appendix verweisen
