...
As one can see, the absolute numbers displayed in brackets in Fig.~\ref{fig:fig:confusion_nonoise} show that the test set is naturally heavily biased towards SNe Ia as well (like the training set), and only 15 TDEs are present.
