...
\begin{figure*}[htb]
    ...
    \caption[\emph{AT2019fdr} light and SED]{Light curve and SED of \emph{AT2019fdr}. The three panels on the top show the double blackbody fits for the three epochs marked in light gray. On the bottom, the ZTF \textit{g}- and \textit{WISE W1}-band light curve is shown (green circles and gray pentagons), as well as the modeled dust echo emission (black dsh-dotted line). Figure by the author, from~\cite{Reusch2022}.}
    \labfig{at2019fdr_lightcurve_and_sed}
\end{figure*}

In each iteration of the minization process, the spectrum of both blackbodies constructed as such were then reddened, and redshifted. After this, the flux of the two blackbody spectra was added.
