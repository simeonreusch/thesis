...
As stated above, I tried a variety of models:
...
I imported the measurements, averaged each the flux in each band per epoch, and passed them to the minimizer (the fit priors are shown in Table~\ref{tab:double_bb_priors}).
