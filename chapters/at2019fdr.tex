...
\todo{Explain the fit a bit more with the figure values}
As not all measurements from the various instruments had the luxury of readily available reference images for easy extraction of transient light (as is e.g.\ the case for ZTF), we constructed a \textbf{synthetic model} of the emission from the host galaxy.\todo{state that its not 3D (like not morphological)}
