...
\labch{ZTF}
The second instrument relevant for this thesis is the \textbf{Zwicky Transient Facility} (ZTF). It is named after the notorious Swiss-American astronomer Fritz Zwicky\sidenote{Zwicky first employed the Virial theorem to infer the existence of dark matter~\cite{Zwicky1933}. Furthermore, together with Walter Baade, he posited the existence of supernovae and the creation of neutron stars in such events~\cite{Baade1934}.}.
