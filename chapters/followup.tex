...
\begin{figure*}[htb]
    ...
    \caption[AT2019dsg optical/UV light curve]{Optical (rotated red squares and green crosses) and UV (all other datapoints) light curve of \textit{AT2019dsg}. The neutrino arrival time of \textit{IC191001A} is marked with a black dotted line. From~\cite{Stein2021}}
    \labfig{at2019dsg_lc}
\end{figure*}
