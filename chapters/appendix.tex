...
\end{tabular}
\caption{Archival measurements from \textit{GALEX}, SDSS, UKIRT (the isoMag value was given without error) and \textit{WISE}, used to construct the synthetic host model (see \ref{synthetic_host_model}). From \cite{Reusch2022}.}
