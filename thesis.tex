...
The most prevalent interpretation of these two populations is that long GRBs are the gamma-ray signature of CCSNe, while short GRBs stem from the merger of two compact objects, e.g. neutron stars. The latter was hypothesized for long, and found spectacular confirmation with the association of a SGRB detected \SI{1.7}{\s} after a gravitational wave signal was detected from the same region, most likely stemming from the merger of two neutron stars \sidecite{Abbott2017}.
\todo{factcheck}
