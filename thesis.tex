...
Interestingly, also PS1-10adi showed late-stage rebrightening \cite{Jiang2019}. 

\subsection{Additional evidence}
As shown in Section \ref{x_ray_obs}, AT2019fdr was detected by \textit{SRG}/eROSITA on the first visit with an unusually soft thermal spectrum of \SI[parse-numbers = false]{56^{+32}_{-26}}{\eV}.  
