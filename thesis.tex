...
\begin{marginfigure}
    ...
    \caption[Neutrino flux contribution pie chart]{Pie chart of the contribution of known neutrino source classes as well as \textit{other}, comprising all source classes without association (main circle). The inner circle  Adopted from \cite{Bartos2021} with minor error correction.}
    \labfig{pie_chart}
\end{marginfigure}
