...
\begin{figure}[htb]
    \includegraphics[width=1\textwidth]{at2019fdr/at2019fdr_bb_chisq.pdf}
    \caption[Uncertainty estimation for double BB fit]{Uncertainty estimation for the double blackbody fits. Here, the uncertainty of the temperature $T_1$ of the hot (`blue') blackbody during epoch 0 is estimated. The blue points show the \SI{68}{\percent} confidence level.}
    \labfig{bb_chisq}
\end{figure}
