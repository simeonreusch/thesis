...
NGC 1068 is an active galaxy, located relatively nearby (the distance is \SI{\sim 14}{\mega\parsec}) \sidecite{Abbasi2022}. It was classified as Seyfert II galaxy, i.e. without signs of a jet, and viewed relatively edge-on, with dust obscuring the SMBH and the BLR (see Section \ref{agn}).
%\sidecite{Murase2020}
