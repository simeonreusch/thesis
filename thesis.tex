...
\begin{marginfigure}
    ...
    \caption[Hess in his balloon]{Hess in his balloon after landing, having discovered cosmic rays in 1912. From \cite{Steinmaurer1985}.}
    \labfig{hess_balloon} 
\end{marginfigure}
Cosmic rays were discovered in 1912 by Victor Hess. It had already been established that clean air in an isolated vessel is still slightly conductive. This was attributed to ionizing particles -- when shielding the isolated vessel, the ionization would decrease. The source of these ionizing particles was unknown. Hess measured the flux of ionizing radiation with three electrometers, in a balloon. In total, he carried out 10 balloon ascents in the time period of 1911--1913. The first ascent over \SI{5}{\km} in August 1912 marked the discovery of cosmic rays, when he registered a 16-fold increase in ionization in the electrometers \sidecite{Steinmaurer1985}.
