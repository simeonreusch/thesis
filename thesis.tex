...
During a CCSN, temperatures of \SI{1e11}{\K} are reached. The environment of the core is dense and optically thick. Because of this, photons are unable to escape, as they immediately produce electron-positron pairs. These in turn are quickly absorbed by the surrounding matter. The large binding energy released in the core of \SI{\sim1e53}{\erg} is carried away by neutrinos (see panels (e) and (f) in Fig. \ref{fig:ccsn_schematic}). Through the annihilation of electron-positron pairs mediated by the $Z$ boson ($e^- + e^+ \rightarrow Z \rightarrow \nu + \bar{\nu}$ \sidecite{Grupen2005}), neutrinos of all flavors are formed and escape the supernova with an average energy on the order of \SI{10}{\mega\eV} \cite{Giunti2007}.

Certain types of CCSNe are thought not only to produce low-energy, but also high-energy neutrinos. Optical observations have stipulated that supernova progenitors often eject material into the circumstellar region \sidecite{Ofek2014}. When the supernova happens, ejecta are driven into this circumstellar material (CSM)

SNe of type IIn are a subclass first stipulated by Schlegel \sidecite{Schlegel1990}, with the IIn chosen to highlight the narrow emission lines found in their spectra. 

Such a system might be promising for the production of high-energy neutrinos, as highlighted in \sidecite{Kurahashi2022}. 
