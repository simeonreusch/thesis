...
\begin{marginfigure}
    ...
    \labfig{hess_balloon} 
\end{marginfigure}
Cosmic rays were discovered in 1912 by Victor Hess. It had already been discovered that electroscopes -- devices measuring electric charge and voltage -- sometimes suddenly discharged. This was attributed to particles ionizing the air in the vessel, making it conductive and therefore allowing it to discharge. This was corroborated by the fact that reduced air pressure would slow the speed of the discharge. When shielding the isolated vessel, the ionization would decrease. The source of these ionizing particles was unknown.
...
More than 100 years later, we know that this ionizing radiation consists of subatomic particles. They are mostly protons, but 

\subsection{Diffuse shock acceleration}
