...
The classification for the 205 candidates selected by \texttt{nuztf} can be seen in Fig. \ref{fig:classification_overview}. The vast majority of transients have some kind of classification. These classifications either stem from spectroscopic follow-up by us. In some cases, promising candidates were already spectroscopically classified by the ZTF Bright Transient Survey (BTS) \sidecite{Fremling2020,Perley2020}, which aims to classify every transient detected by ZTF brighter than \SI{19}{\mag}.
