...
A second source candidate, also coincident with IC200530A, was SN2020lam (ZTF20abbpkpa) \sidecite{IC200530A3} with a supernova-like light curve. To obtain a classification, we took a spectrum with NOT/ALFOSC\todo{PI: J. Sollerman?} on June 6, 2020. Template fitting with \texttt{SNID} and \texttt{GELATO} \sidecite{Harutyunyan2008} identified the source as a supernova of type IIP (see Fig. \ref{fig:ZTF20abbpkpa_not_spectrum}).
...
\begin{figure}[htb]
    ...
    \caption[AT2020osi spectrum]{Spectrum of AT2020osi taken with Keck/GMOS-N. The telluric absorption areas are shown in gray, and Balmer lines are shown as black dotted lines. The redshift is 0.194.}
...
When following up IC220907A \sidecite{IC220907A1}, AT2022oyn (ZTF22aatwsqt) emerged as notable source candidate.
