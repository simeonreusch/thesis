...
NGC 1068 and TXS 0506+056 each contribute \SI{\sim 1}{\percent} of the overall diffuse flux of astrophysical neutrinos measure by IceCube in their respective energy range. So far, it is not constrained if the diffuse flux is mainly composed of bright and nearby sources akin to NGC 1068, a large population of faint sources with high redshifts ($z \geq 1$), or a combination of both. Given the big differences in distance between NG 1068 and TXS 0506+056 (the latter is about 100 times farther away) and the differences in their respective spectra, it seems plausible to assume at least two distinct AGN source populations \cite{Abbasi2022}.
