...
This source candidate was found in coincidence with high-energy neutrino IC200530A \sidecite{IC200530A1,IC200530A2,IC200530A4}. 

We took a spectrum with NOT/ALFOSC on June 12, 2020 and used the Supernova Identification (\texttt{SNID}) code \sidecite{Blondin2007} to fit spectra of different types supernovae to the spectrum. The best fit spectrum was a type Ic supernova at redshift $z=0.041$, \SI{14}{\day} post peak. The spectrum and the template are shown in Fig. \ref{fig:ZTF20abdnpdo_spectrum}. 
...
The light curve including an early forced photometry detection in the \textit{i}-band was fit using the Modular Open Source Fitter for Transients (\texttt{MOSFiT}) \sidecite{Guillochon2018}. 
