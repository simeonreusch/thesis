...
The host model was subsequently subtracted evaluated for all non-subtracted measurements with their respective bandpass using \texttt{SNCosmo} \sidecite{Barbary2022}, a Python framework dedicated to supernova analysis.
