...
Most of the classified candidates were SNe Ia. This is not surprising, as the majority of transients detected by ZTF are SNe Ia, due to their intrinsic brightness. Among the other transients, only the two TDEs were identified as source candidates. The remaining non-Ia supernovae could be ruled out as potential sources, as theey showed either no sign of CSM interaction, or -- in the case of the SN Ic -- the explosion predated the neutrino detection significantly (see Section \ref{SN2020lls}).
