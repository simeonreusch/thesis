...
Roughly half of the transients are classified as \textit{AGN Variability}, e.g. stochastic AGN activity without a prominent optical flare visible around the time of neutrino detection. 5 transients 
