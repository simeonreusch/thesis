...
The details of the \textit{Fermi} LAT analysis are published in \sidecite{Velzen2021}. The one year long time window analyzed for AT2019fdr spanned from the first optical detection of the source on May 3, 2019, until the arrival of the neutrino on May 30, 2020.

No gamma-ray sources were detected significantly (\SI{\geq 5}{\sigma}), neither new sources nor previously known sources from the 10 year \textit{Fermi} LAT Fourth Source Catalog (4FGL-DR2) \sidecite{Abdollahi2020,Ballet2020}.
