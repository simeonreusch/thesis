...
\end{equation}
where the sum is the cumulative distribution function of the Poisson distribution.

Using a right-tailed normal distribution, this translates to $\SI{3.4}{\sigma}$ (\SI{1.94}{\sigma} for a single association).
