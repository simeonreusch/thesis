...
The blazar has a redshift of $z=0.337 \pm 0.001$ \sidecite{Paiano2018}, and a search for additional excess neutrinos from its sky location in 9.5 years of IceCube data found another episode of heightened activity. During September 2014 and March 2015, with neutrino flux from the direction of TXS 0506+056 at the $3.5\sigma$ level \sidecite{Aartsen2018a}.

Several attempts to model the SED resulting in producing a flux of high-energy neutrinos compatible with the IceCube detection were made, an example is shown in Fig. \todo{sed hier}. 

NGC 1068 is an active galaxy, located relatively nearby (the distance is \SI{\sim 14}{\mega\parsec}) \sidecite{Abbasi2022}. It was classified as Seyfert II galaxy, i.e. without signs of a jet, and viewed relatively edge-on, with dust obscuring the SMBH and the BLR (see Section \ref{agn}) \sidecite{Rosas2022}. It has an exceptionally high rate of star formation, and 

In 2022, an archival study comprising IceCube data from 2011--2020 found an excess of $79^{+22}_{-20}$ neutrinos with \unit{\tera\eV} energies from the location of NGC 1068 \sidecite{Abbasi2022}.
