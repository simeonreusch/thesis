...
\begin{figure}[htb]
    ...
    \caption[\textit{SRG}/eROSITA temperature fit]{Temperature fit for the \textit{SRG}/eROSITA detection. Figure by M. Gilfanov.}
    \labfig{erosita_fit}
\end{figure}
...
\begin{figure}[htb]
    ...
    \caption[\textit{NEOWISE} forced photometry]{\textit{NEOWISE} forced photometry light curve at the location of AT2019fdr. The arrival time of neutrino IC200530A is marked with a dotted black line. From \cite{Velzen2021}}
